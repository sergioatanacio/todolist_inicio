...
export class KanbanTimelineService {
  buildByDisponibilidad(
    disponibilidad: DisponibilidadAggregate,
    tasks: TaskAggregate[],
    slotMinutesRaw?: number,
  ): KanbanTimeline {
    const slotMinutes = clampSlotMinutes(slotMinutesRaw)
    ...
    const orderedTasks = [...tasks].sort((a, b) => a.orderInList - b.orderInList)
